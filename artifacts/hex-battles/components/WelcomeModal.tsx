        ...
        <View style={styles.container}>
          ...
          >
            ...
            <Section title="Improvements">
              <Text style={styles.body}>
                A territory may found one <Text style={styles.highlight}>City</Text> for every <Text style={styles.highlight}>5 tiles</Text> it owns, and a new City must sit at least <Text style={styles.highlight}>4 tiles</Text> from every City you already own, anywhere on the map. Enemy and neutral cities don't block you.
              </Text>
              <Text style={[styles.body, { marginTop: 8 }]}>
                You can improve a tile within <Text style={styles.highlight}>2 tiles</Text> of one of your Cities in that same territory, counted along a route the City can actually reach: <Text style={styles.highlight}>Mountains block, and so does water you have not spanned with a Bridge of your own</Text>. A City in a different territory of yours doesn't extend the zone. Turn grass into a <Text style={styles.highlight}>Field</Text> (<Text style={styles.gold}>3 gold</Text>), forest into a <Text style={styles.highlight}>Sawmill</Text> (<Text style={styles.gold}>4 gold</Text>), or desert into a <Text style={styles.highlight}>Mine</Text> (<Text style={styles.gold}>5 gold</Text>). Improving uses up nothing but gold. Each City pays for <Text style={styles.highlight}>one improvement per turn</Text>; a tile in range of several of your Cities uses the nearest one that hasn't built yet.
              </Text>
              <Text style={[styles.body, { marginTop: 8 }]}>
            ...
            <Section title="Terrain">
              {[
                ...
                { name: 'Forest', desc: 'Same income as grass, but costs 2 movement to enter — 1 once a city stands on it' },
