        ...
        <View style={styles.modalContainer}>
          ...
          <ScrollView contentContainerStyle={styles.modalScroll} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.ruleSection}>
              ...
              <Text style={[styles.ruleBody, { marginTop: 8 }]}>
                You can improve a tile within 2 tiles of one of your Cities in that same territory, counted along a route the City can actually reach — Mountains block, and so does water you have not spanned with a Bridge of your own: grass into a Field (3 gold), forest into a Sawmill (4 gold), or desert into a Mine (5 gold). Improving uses up nothing but gold.
              </Text>
              <Text style={[styles.ruleBody, { marginTop: 8 }]}>
            ...
            <View style={styles.ruleSection}>
              ...
              {[
                ...
                { name: 'Forest', desc: 'Good income like grass, but costs 2 movement to enter — 1 once a city stands on it' },
