...
export const ENTITY_META: Record<EntityType, EntityMeta> = {
  ...
  advanced_unit: { name: 'Advanced Unit', icon: '🛡️',  cost: 20, upkeep: 9,  isUnit: true,  strength: 2 },
  expert_unit:   { name: 'Expert Unit',   icon: '🗡️',  cost: 30, upkeep: 27, isUnit: true,  strength: 3 },
