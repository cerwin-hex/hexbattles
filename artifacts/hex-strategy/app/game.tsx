...
const EntityLayer = React.memo(EntityLayerInner, areEntityLayerEqual);

interface BorderEdgeLayerProps {
...
interface FortificationDotLayerProps {
  fortificationDots: Set<string>;
  tileDataMap: Map<string, { cx: number; cy: number }>;
  boardW: number;
  boardH: number;
...
const FortificationDotLayer = React.memo(
